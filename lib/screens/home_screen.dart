...
class _HomeScreenState extends State<HomeScreen>
  ...
  try {
    final moviesJson = await _apiServices.getAllMovies();
    final trendingJson = await _apiServices.getTrendingMovies();
    final popularJson = await _apiServices.getPopularMovies();

    setState(() {
      _allMovies = moviesJson.map((json) => Movie.fromJson(json)).toList();
      _trendingMovies = trendingJson.map((json) => Movie.fromJson(json)).toList();
      _popularMovies = popularJson.map((json) => Movie.fromJson(json)).toList();
    });
  } catch (e) {
